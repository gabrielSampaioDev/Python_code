...
valor_casa = float(input('Qual o valor da \033[33mcasa\033[m? '))# Valor total da casa 
Salario = float(input('Qual o valor do seu \033[33msalário\033[m? '))# Valor do salário mensal recebido
prazo = float(input('Em quantos anos você irá \033[33mfinalizar o pagamento\033[m? '))# Prazo de quitação do AP
